...
export default function IntermediatePage() {
  ...
  // stages: loading | question | correct | info | final | no-quiz
  ...
  async function handleAnswer(isCorrect) {
    ...
    console.log("INFO IMAGE URL:", q.imageUrl); // debug
  ...
  if (stage === "loading") {
    return (
      <>
        <QuizTopbar title="Intermediate Level" diamonds={diamonds} />
  ...
  const qCurrent = questions[current];
  if (!qCurrent) return null;
  ...
  return (
    <div className="quiz-wrapper">
      ...
      <div className="quiz-center-box">
        {stage === "question" && (
          <QuestionScreen q={qCurrent} handleAnswer={handleAnswer} />
        )}

        {stage === "info" && (
          <InfoScreen image={qCurrent.imageUrl} onNext={nextFromInfo} />
        )}
      </div>
